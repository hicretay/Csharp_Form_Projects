...
namespace Veritabani_Örnek
{
    public partial class Form1 : Form
    {
        ...
        int id = 0;
        SqlConnection baglan = new SqlConnection("Data Source=localhost;Initial Catalog=Kütüphane;Integrated Security=True");
        ...
        {
            baglan.Open();
            SqlCommand komut = new SqlCommand("Insert into kitaplar (id,kitapad,yazar,yayinevi,sayfa)Values" +
